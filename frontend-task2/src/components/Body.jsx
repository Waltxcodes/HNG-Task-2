  ...
  return (
    <>
      <div className="body bg-white" style={{ backgroundColor: "#FAF9F6" }}>
        <div className="flex flex-col md:flex-row items-start justify-evenly space-y-6 md:space-y-0 md:space-x-10 lg:space-x-40 pt-6">
        ...
        <div className="flex flex-col md:flex-row justify-evenly space-y-4 md:space-y-0 md:space-x-4 lg:space-x-10 mt-6">
          <div className="px-4 py-2 rounded-md border border-black text-center">
            <p>New Arrivals</p>
          </div>
          <div className="px-4 py-2 rounded-md border border-black text-center">
            <p>Top Rated</p>
        ...
        <div className="flex flex-col md:flex-row justify-evenly space-y-6 md:space-y-0 md:space-x-6 lg:space-x-10 mt-10">
          <div className="bg-white rounded-md pb-4 shadow-md flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row justify-evenly space-y-6 md:space-y-0 md:space-x-6 lg:space-x-10 mt-10">
          ...
          <div className="bg-white rounded-md shadow-md flex flex-col items-center">
            ...
            <p className="text-center text-xl md:text-2xl font-semibold mt-4">Cuddler Chair</p>
            <img src={fourstar} alt="four-star" className="mt-2" />
